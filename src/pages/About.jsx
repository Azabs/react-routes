    ...
    <div className="about">
      <div className="description bg-primary text-light px-4 py-2 mt-5 mb-4 text-justify">
        ...
        <p>
          ...
          <i>Qui ita affectus, beatum esse numquam probabis;</i>{" "}
          <b>Qui convenit?</b>{" "}
          <b>Nosti, credo, illud: Nemo pius est, qui pietatem-;</b> Facillimum
          id quidem est, inquam. Duo Reges: constructio interrete. Sed erat
          aequius Triarium aliquid de dissensione nostra iudicare.
          <br /> Habes, inquam, Cato, formam eorum, de quibus loquor,
          philosophorum. At ille non pertimuit saneque fidenter: Istis quidem
          ipsis verbis, inquit; Mihi enim satis est, ipsis non satis. Paulum,
          cum regem Persem captum adduceret, eodem flumine invectio? Est igitur
      ...
      <dl className="shadow text-center text-light">
        ...
        <dt>
          <dfn className="h2">Tria genera bonorum;</dfn>
        </dt>
        <dd>
          Sed quia studebat laudi et dignitati, multum in virtute processerat.
        </dd>
        <dt>
          <dfn className="h2">Sed fortuna fortis;</dfn>
        </dt>
